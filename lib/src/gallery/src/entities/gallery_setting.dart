...
class GallerySetting {
  ...
  GallerySetting({
    ...
    this.noPhotoMsg = 'No media available',
    this.photoPermissionRequestMsg,
    this.cameraPermissionRequestMsg,
    this.allowAccessText,
    this.maximumImageChoose,
    this.cancelLabel,
    this.unselectItemsLabel,
    this.confirmUnselectTitle,
    this.confirmUnselectMsg,
    this.editLabel,
    this.selectLabel,
  }) {
    backupEntities = selectedEntities.toList();
  }

  ///
  /// Previously selected entities
  late final List<DrishyaEntity> backupEntities;
  ...
  ///
  /// Show message if app need alow access
  final String? photoPermissionRequestMsg;

  ///
  /// Show message if app need alow access
  final String? cameraPermissionRequestMsg;

  ///
  /// Show message if app need alow access
  final String? allowAccessText;

  ///
  /// Show message if maximum image is choose
  final String? maximumImageChoose;

  ///
  /// cancel label in popup
  final String? cancelLabel;

  ///
  /// unselect label in popup
  final String? unselectItemsLabel;

  ///
  /// confirm unselect title in popup
  final String? confirmUnselectTitle;

  ///
  /// confirm unselect message in popup
  final String? confirmUnselectMsg;
  ...
  GallerySetting copyWith({
    ...
    String? photoPermissionRequestMsg,
    String? cameraPermissionRequestMsg,
    String? allowAccessText,
    String? maximumImageChoose,
    String? cancelLabel,
    String? unselectItemsLabel,
    String? confirmUnselectTitle,
    String? confirmUnselectMsg,
    String? editLabel,
    String? selectLabel,
  }) {
    return GallerySetting(
      ...
      photoPermissionRequestMsg:
          photoPermissionRequestMsg ?? this.photoPermissionRequestMsg,
      cameraPermissionRequestMsg:
          cameraPermissionRequestMsg ?? this.cameraPermissionRequestMsg,
      allowAccessText: allowAccessText ?? this.allowAccessText,
      maximumImageChoose: maximumImageChoose ?? this.maximumImageChoose,
      cancelLabel: cancelLabel ?? this.cancelLabel,
      unselectItemsLabel: unselectItemsLabel ?? this.unselectItemsLabel,
      confirmUnselectTitle: confirmUnselectTitle ?? this.confirmUnselectTitle,
      confirmUnselectMsg: confirmUnselectMsg ?? this.confirmUnselectMsg,
