...
class GalleryController extends ValueNotifier<GalleryValue> {
  ...
  GalleryController({this.singleSelection = false})
      : panelKey = GlobalKey(),
  ...
  ///
  /// Toggle force multi selection button
  @internal
  ...
  void _showSnackBarLimited(BuildContext context) {
    UIHandler.of(context).showSnackBar(
      setting.maximumImageChoose ??
  ...
  Future<List<DrishyaEntity>> _collapsibleGallery(BuildContext context) {
  ...
  Future<List<DrishyaEntity>> pick(
    ...
    return _collapsibleGallery(context);
  }
  ...
  //   if (_setting.selectionMode == SelectionMode.actionBased) {
  //     return !value.enableMultiSelection;
  //   }
  //   return false;
  // }
  ///
