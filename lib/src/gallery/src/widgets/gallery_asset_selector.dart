...
class GalleryAssetSelectorState extends State<GalleryAssetSelector>
  ...
  void initState() {
    ...
    if (widget.controller.value.selectedEntities.isNotEmpty) {
    ...
    widget.controller.addListener(() {
      if (mounted) {
        ...
        final sizeSelected =
            widget.controller.setting.selectedEntities.length + entities.length;
        if (sizeSelected == 0 && _selectOpaController.value == 1.0) {
  ...
  Widget build(BuildContext context) {
    ...
    return ValueListenableBuilder<GalleryValue>(
      ...
      builder: (context, value, child) {
        ...
        // }
        const canEdit = false; // remove edit
        return Column(
          children: [
                        ...
                        child: AnimatedBuilder(
                          ...
                          builder: (context, child) {
                            ...
                            return hide
                                ? const SizedBox()
                                : Opacity(
                                    opacity: _editOpa.value, child: child);
                          },
                          child: SizedBox(
                            width: buttonWidth,
                            child: _TextButton(
                              ...
                              label:
                                  widget.controller.setting.editLabel ?? 'EDIT',
                      ...
                      child: AnimatedBuilder(
                        ...
                        child: AnimatedBuilder(
                          ...
                          child: _TextButton(
                            ...
                            label: widget.controller.setting.selectLabel ??
                                'SELECT',
                          ),
                        ),
                      ),
