...
class ScrollListener extends StatefulWidget {
  ...
  ///
  final void Function(ScrollController? controller, {required bool overScroll})
      onScrollUpdate;
...
class ScrollListenerState extends State<ScrollListener> {
  ...
  void _scrollEnd(ScrollEndNotification notification) {
  ...
  void _finish(ScrollNotification notification, bool overScroll) {
    ...
    widget.onScrollUpdate(controller, overScroll: overScroll);
